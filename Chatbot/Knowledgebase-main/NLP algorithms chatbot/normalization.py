...
'turi', 'uz', 'labai', 'del', 'kuri', 'kokie', 'prie', 'kokias', 'koki', 'buvo', 'i', 'jei', 'jeigu', 'kelinta', 'kada', 'gauti', 'noreti', 'matyti', 'kokiomis']
...
def lem(word):
        if(word == 'sveikas' or word == 'sveika' or word == 'laba' or word == 'labas' or word == 'hello' or word == 'hey' or word == 'sveiki'):
            ...
            return 'tvarkarastis'
        elif(word == 'kalendoriu' or word == 'kalendoriui' or word == 'kalendoriai' or word == 'kalendoriuje'):
            return 'kalendorius'
            ...
            return 'fakultetas'
        elif(word == 'salygas' or word == 'salygos' or word == 'salygomis'):
            return 'salyga'
            ...
            return 'studentas'
        elif(word == 'prasymu' or word == 'prasymus' or word == 'prasyma' or word == 'prasymo'):
            return 'prasymas'
            ...
            return 'zemelapis'
        elif(word == 'gaunu' or word == 'gauni' or word == 'gavau' or word == 'gavimo' or word == 'gaunama' or word == 'gautas'):
            return 'gauti'
        elif(word == 'skelbimai' or word == 'skelbimui' or word == 'skelbimus'):
            return 'skelbimas'
        elif(word == 'ismokos' or word == 'ismokamos' or word == 'ismoketas' or word == 'ismokas' or word == 'ismoku'):
            return 'ismoka'
        elif(word == 'gatveje'):
            return 'gatve'
            ...
            return 'destytojas'
        elif(word == 'dalyku' or word == 'dalykus' or word == 'dalyko'):
            return 'dalykas'
            ...
            return 'nauda'
        elif(word == 'padeti' or word == 'pagalbos'):
            return 'pagalba'
            ...
            return 'skirymas'
        elif(word == 'semestro' or word == 'semestre'):
            return 'semestras'
            ...
            return 'mechnika'
        elif(word == 'katedros' or word == 'katedru'):
            return 'katedra'
        elif(word == 'pilna'):
            return 'pilnas'
        elif(word == 'statybos'):
            ...
            return 'lapas'
        elif(word == 'atvejeis' or word == 'atvejai' or word == 'atveju' or word == 'atvejais'):
            return 'atvejis'
        elif(word == 'prasimu'):
            return 'prasimas'
        elif(word == 'israsomos' or word == 'israsas' or word == 'israsyta'):
            return 'israsyti'
        elif(word == 'atostogas'):
            return 'atostogos'
        elif(word == 'naudojama' or word == 'pasinaudoti'):
            return 'naudotis'
        else:
            return word
